...
private fun deepEqualsPointAnnotationMessenger(a: Any?, b: Any?): Boolean {
  ...
  if (a is Array<*> && b is Array<*>) {
    return a.size == b.size &&
      a.indices.all { deepEqualsPointAnnotationMessenger(a[it], b[it]) }
  }
  if (a is Map<*, *> && b is Map<*, *>) {
    return a.size == b.size && a.keys.all {
      (b as Map<Any?, Any?>).containsKey(it) &&
        deepEqualsPointAnnotationMessenger(a[it], b[it])
    }
  }
  return a == b
}
...
data class PointAnnotation(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    return id == other.id &&
      ...
      deepEqualsPointAnnotationMessenger(image, other.image) &&
      iconAnchor == other.iconAnchor &&
      iconImage == other.iconImage &&
      deepEqualsPointAnnotationMessenger(iconOffset, other.iconOffset) &&
      iconRotate == other.iconRotate &&
      iconSize == other.iconSize &&
      iconTextFit == other.iconTextFit &&
      deepEqualsPointAnnotationMessenger(iconTextFitPadding, other.iconTextFitPadding) &&
      ...
      deepEqualsPointAnnotationMessenger(textOffset, other.textOffset) &&
